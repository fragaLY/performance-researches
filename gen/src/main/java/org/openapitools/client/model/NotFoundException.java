...
public class NotFoundException {
  ...
  public NotFoundException status(String status) {
   ...
   * @return message
   **/
  @ApiModelProperty(example = "Challenge not found", required = true, value = "")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, notFoundException.status) &&
        Objects.equals(this.code, notFoundException.code) &&
