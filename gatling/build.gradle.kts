...
dependencies {
    //region gatling
    implementation("io.gatling:gatling-http:3.14.5")
    implementation("io.gatling:gatling-core:3.14.5")
    implementation("io.gatling:gatling-app:3.14.5")
    gatlingRuntimeOnly("io.gatling:gatling-charts:3.14.5")
    gatlingRuntimeOnly("io.gatling.highcharts:gatling-charts-highcharts:3.14.5")
    //endregion
}
