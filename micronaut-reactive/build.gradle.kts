plugins {
    ...
    id("io.micronaut.graalvm") version "4.4.3"
    id("io.micronaut.docker") version "4.4.3"
...
dependencies {
    ...
    implementation("io.micronaut.serde:micronaut-serde-jackson:2.11.2")
    implementation("io.micronaut.data:micronaut-data-r2dbc:4.9.5")
