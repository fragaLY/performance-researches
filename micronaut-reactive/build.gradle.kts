plugins {
    ...
    id("io.micronaut.graalvm") version "4.3.8"
...
dependencies {
    ...
    implementation("io.micronaut.serde:micronaut-serde-jackson:2.10.0")
    implementation("io.micronaut.data:micronaut-data-r2dbc:4.7.0")
