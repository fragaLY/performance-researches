...
dependencies {
    ...
    implementation("io.micronaut.serde:micronaut-serde-jackson:2.5.0")
    implementation("io.micronaut.data:micronaut-data-r2dbc:4.4.0")
    implementation("io.micronaut.reactor:micronaut-reactor-http-client:3.2.0")
